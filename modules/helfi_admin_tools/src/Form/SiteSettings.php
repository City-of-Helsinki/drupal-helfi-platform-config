...
namespace Drupal\helfi_admin_tools\Form;

/**
 * @file
 * Contains Drupal\helfi_admin_tools\Form\SiteSettings.
 */
...
class SiteSettings extends ConfigFormBase {
  ...
  public function getFormId() : string {
    return 'helfi_admin_tools_site_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) : array {
    ...
    $form['#attached']['library'][] = 'helfi_admin_tools/site_settings';
