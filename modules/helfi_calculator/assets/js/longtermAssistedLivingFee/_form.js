  ...
  return {
    ...
    items: [
      ...
      },
      {
        input_float: {
          id: 'medication_costs',
          label: t('medication_costs'),
          unit: t('unit_euro'),
          min: 0,
          size: 20,
          required: false,
          strip: '[€eE ]',
          helper_text: t('medication_costs_explanation'),
        },
      },
      {
        input_float: {
          id: 'share_of_housing_costs',
          label: t('share_of_housing_costs'),
          unit: t('unit_euro'),
          min: 0,
          size: 20,
          required: false,
          strip: '[€eE ]',
          helper_text: t('share_of_housing_costs_explanation'),
        },
      },
      {
        radio: {
      ...
      },
      {
        group: {
          ...
          items: [
            ...
            {
              input_float: {
                id: 'spouse_medication_costs',
                label: t('spouse_medication_costs'),
                unit: t('unit_euro'),
                min: 0,
                size: 20,
                required: false,
                strip: '[€eE ]',
                helper_text: t('spouse_medication_costs_explanation'),
              },
            },
            {
              input_float: {
                id: 'spouse_share_of_housing_costs',
                label: t('spouse_share_of_housing_costs'),
                unit: t('unit_euro'),
                min: 0,
                size: 20,
                required: false,
                strip: '[€eE ]',
                helper_text: t('spouse_share_of_housing_costs_explanation'),
              },
            },
          ],
        },
